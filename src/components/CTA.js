      ...
      <div className="section-container">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-600 to-blue-800 px-8 py-16 md:px-16 md:py-24">
          ...
          <div className="relative z-10 text-center">
            ...
            <p className="text-lg text-white/80 max-w-2xl mx-auto mb-8">Join thousands of traders predicting the future with Polyshop. Create your account in seconds and start trading today.</p>
